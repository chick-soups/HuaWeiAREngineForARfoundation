Shader "Unlit/AREngineBackground"
{
    Properties
    {
    ...
    SubShader
    {
        Name "AREngine Background (Before Opaques)"
        Tags
        {
            "Queue" = "Background"
        ...
        Pass
        {
            Name "AR Camera Background (AREngine)"
            Cull Off
            ZTest Always
            ZWrite On
            Lighting Off
            ...
            #pragma multi_compile_local __ ARENGINE_ENVIRONMENT_DEPTH_ENABLED
...
#extension GL_OES_EGL_image_external_essl3 : require
            ...
            void main()
            {
                ...
                textureCoord = (_UnityDisplayTransform * vec4(gl_MultiTexCoord0.x, 1.0f - gl_MultiTexCoord0.y, 1.0f, 1.0f)).xy;
#endif // SHADER_API_GLES3
            }
#endif // VERTEX
...
#ifdef ARENGINE_ENVIRONMENT_DEPTH_ENABLED
            uniform sampler2D _EnvironmentDepth;
#endif // ARENGINE_ENVIRONMENT_DEPTH_ENABLED
